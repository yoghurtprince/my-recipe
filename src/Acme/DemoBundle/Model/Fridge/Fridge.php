...
namespace Acme\DemoBundle\Model\Fridge;

use Acme\DemoBundle\Model\Fridge\Exceptions\InsufficientQuantity;
use Acme\DemoBundle\Model\Fridge\Exceptions\ItemExpired;
use Acme\DemoBundle\Model\Fridge\Exceptions\ItemNotExists;
use Acme\DemoBundle\Model\Food\Item as FoodItem;
use Acme\DemoBundle\Model\Food\Items as FoodItems;
